      ...
      dbroot.StyleAttributeProto = (function () {
        ...
        StyleAttributeProto.fromObject = function fromObject(object) {
          ...
          if (
            ...
            message.placemarkIconColorAbgr =
              object.placemarkIconColorAbgr >>> 0;
          if (
      ...
      dbroot.StyleMapProto = (function () {
        ...
        StyleMapProto.fromObject = function fromObject(object) {
          ...
          if (
            ...
            message.highlightStyleAttribute =
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 11:
                ...
                break;
              case 12:
                message.description = $types[12].decode(
                  reader,
                  reader.uint32()
                );
                break;
      ...
      dbroot.ClientOptionsProto = (function () {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 15:
                ...
                break;
              case 16:
                message.mapsOptions = $types[15].decode(
                  reader,
                  reader.uint32()
                );
                break;
        ...
        ClientOptionsProto.fromObject = function fromObject(object) {
          ...
          if (
            ...
            message.captureOptions = $types[8].fromObject(
        ...
        ClientOptionsProto.MapsOptions = (function () {
          ...
          MapsOptions.toObject = function toObject(message, options) {
            ...
            if (
              ...
              object.docsAutoDownloadInterval =
                message.docsAutoDownloadInterval;
            if (
      ...
      dbroot.FetchingOptionsProto = (function () {
        ...
        FetchingOptionsProto.fromObject = function fromObject(object) {
          ...
          if (
            ...
            message.maxConsumerFetchRatio = Number(
        ...
        SearchTabProto.InputBoxInfo = (function () {
          ...
          InputBoxInfo.fromObject = function fromObject(object) {
            if (
              ...
              return object;
            var message =
              new $root.keyhole.dbroot.SearchTabProto.InputBoxInfo();
      ...
      dbroot.DatabaseDescriptionProto = (function () {
        ...
        DatabaseDescriptionProto.decode = function decode(reader, length) {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              case 1:
                message.databaseName = $types[0].decode(
                  reader,
                  reader.uint32()
                );
                break;
      ...
      dbroot.PostingServerProto = (function () {
        ...
        PostingServerProto.fromObject = function fromObject(object) {
          ...
          if (
            ...
            message.postWizardPath = $types[2].fromObject(
          ...
          if (
            ...
            message.fileSubmitPath = $types[3].fromObject(
      ...
      dbroot.EndSnippetProto = (function () {
          ...
          while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
              ...
              case 25:
                ...
                break;
              case 48:
                message.tutorialUrl = $types[28].decode(
                  reader,
                  reader.uint32()
                );
                break;
              ...
              case 67:
                ...
                break;
              case 68:
                message.feedbackUrl = $types[67].decode(
                  reader,
                  reader.uint32()
                );
                break;
        ...
        EndSnippetProto.fromObject = function fromObject(object) {
          ...
          if (object.mfeDomains) {
            ...
            for (var i = 0; i < object.mfeDomains.length; ++i) {
              ...
              message.mfeDomains[i] = $types[3].fromObject(
                object.mfeDomains[i]
              );
            }
          }
          ...
          if (
            ...
            message.skyDatabaseUrl = $types[9].fromObject(
        ...
        EndSnippetProto.toObject = function toObject(message, options) {
          ...
          if (
            ...
            object.csiOptions = $types[39].toObject(
              message.csiOptions,
              options
            );
          if (
          ...
          if (
            ...
            object.searchInfo = $types[52].toObject(
              message.searchInfo,
              options
            );
          if (
          ...
          if (
            ...
            object.sharingUrl = $types[58].toObject(
              message.sharingUrl,
              options
            );
          if (
          ...
          SearchConfigProto.SearchServer = (function () {
            ...
            SearchServer.fromObject = function fromObject(object) {
              ...
              if (
                ...
                message.requirements = $types[8].fromObject(
                  object.requirements
                );
              }
              if (
          ...
          SearchConfigProto.OneboxServiceProto = (function () {
            ...
            OneboxServiceProto.fromObject = function fromObject(object) {
              ...
              if (
                ...
                message.requirements = $types[1].fromObject(
                  object.requirements
                );
              }
              return message;
