...
(function () {
  ...
  function reorder(indices, vertices, optf) {
    ...
    var unique = instance.exports.meshopt_optimizeVertexFetchRemap(
      rp,
      ip,
      indices.length,
      vertices
  ...
  return {
    ...
    encodeVertexBuffer: function (source, count, size) {
      ...
      return encode(
        instance.exports.meshopt_encodeVertexBuffer,
        bound,
        source,
        count,
        size
    ...
    encodeIndexBuffer: function (source, count, size) {
      ...
      var bound = instance.exports.meshopt_encodeIndexBufferBound(
        count,
        maxindex(indices) + 1
      );
      return encode(
        instance.exports.meshopt_encodeIndexBuffer,
        bound,
        indices,
        count,
        4
    ...
    encodeIndexSequence: function (source, count, size) {
      assert(size == 2 || size == 4);
      var indices = index32(source, size);
      var bound = instance.exports.meshopt_encodeIndexSequenceBound(
        count,
        maxindex(indices) + 1
      );
      return encode(
        instance.exports.meshopt_encodeIndexSequence,
        bound,
        indices,
        count,
        4
    ...
    encodeFilterOct: function (source, count, stride, bits) {
      ...
      return filter(
        instance.exports.meshopt_encodeFilterOct,
        source,
        count,
        stride,
        bits,
    ...
    encodeFilterQuat: function (source, count, stride, bits) {
      ...
      return filter(
        instance.exports.meshopt_encodeFilterQuat,
        source,
        count,
        stride,
        bits,
