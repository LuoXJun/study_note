...
import {
  ...
  a as commonjsGlobal
} from './_commonjsHelpers-3aae1032.js';
...
var protobuf = createCommonjsModule(function (module) {
  ...
  (function (global, undefined$1) {
    (function prelude(modules, cache, entries) {
      ...
      // Be nice to CommonJS
      if (module && module.exports) module.exports = protobuf;
    })(
      /* end of prelude */ {
        1: [
        ...
        3: [
          function (require, module, exports) {
            ...
            EventEmitter.prototype.off = function off(evt, fn) {
              if (evt === undefined$1) this._listeners = {};
              else {
                if (fn === undefined$1) this._listeners[evt] = [];
                else {
            ...
            function readLongVarint() {
              ...
              if (this.len - this.pos > 4) {
                ...
                for (; i < 5; ++i) {
                  // 6th..10th
                  bits.hi =
                    (bits.hi | ((this.buf[this.pos] & 127) << (i * 7 + 3))) >>>
                    0;
                  if (this.buf[this.pos++] < 128) return bits;
                }
              } else {
        ...
        16: [
          function (require, module, exports) {
             ...
             * @override
             */
            BufferWriter.prototype.string = function write_string_buffer(
              value
            ) {
