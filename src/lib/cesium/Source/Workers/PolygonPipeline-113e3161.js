...
define([
  ...
  PolygonPipeline.computeSubdivision = function (
    ...
    granularity = defaultValue.defaultValue(
      granularity,
      ...
      if (max > minDistanceSqrd) {
        if (g0 === max) {
          ...
          if (!defaultValue.defined(i)) {
            ...
            if (hasTexcoords) {
              midTexcoord = Matrix2.Cartesian2.add(
                t0,
                t1,
  ...
  PolygonPipeline.computeRhumbLineSubdivision = function (
    ...
    const rhumb0 = new EllipsoidRhumbLine.EllipsoidRhumbLine(
      undefined,
      undefined,
      ellipsoid
    );
    const rhumb1 = new EllipsoidRhumbLine.EllipsoidRhumbLine(
      undefined,
      undefined,
      ellipsoid
    );
    const rhumb2 = new EllipsoidRhumbLine.EllipsoidRhumbLine(
      undefined,
      undefined,
      ellipsoid
    );
