...
define([
  ...
  CoplanarPolygonOutlineGeometry.createGeometry = function (polygonGeometry) {
    ...
    const boundingSphere = Transforms.BoundingSphere.fromPoints(
