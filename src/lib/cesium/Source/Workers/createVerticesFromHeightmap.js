...
define([
  ...
  HeightmapTessellator.computeVertices = function (options) {
    ...
    if (
      !defaultValue.defined(options) ||
      !defaultValue.defined(options.heightmap)
    ) {
      throw new RuntimeError.DeveloperError('options.heightmap is required.');
    }
    if (
      !defaultValue.defined(options.width) ||
    ...
    if (!defaultValue.defined(options.nativeRectangle)) {
      throw new RuntimeError.DeveloperError(
        'options.nativeRectangle is required.'
      );
    }
    ...
    const includeWebMercatorT = defaultValue.defaultValue(
  ...
  var LercDecode = _commonjsHelpers3aae1032.createCommonjsModule(function (
    module
  ) {
    ...
    (function () {
      ...
      var LercDecode = (function () {
        ...
        var parse = function (input, fp, skipMask) {
          ...
          data.fileIdentifierString = String.fromCharCode.apply(
            null,
            fileIdView
          );
              ...
              for (blockX = 0; blockX < numBlocksX; blockX++) {
                ...
                for (iDim = 0; iDim < numDims; iDim++) {
                  ...
                  if (blockEncoding > 3) {
                    ...
                    //1 or 3
                    offsetType = Lerc2Helpers.getDataTypeUsed(
                      imageType,
                      bits67
                    );
      ...
      var Lerc = {
        ...
        decode: function (encodedData, options) {
          ...
          var fileIdentifierString = String.fromCharCode.apply(
            null,
            fileIdView
          );
