...
define([
  ...
  return (
    (E.createGeometry = function (t) {
      ...
      let d, f;
      if (
        n.CesiumMath.equalsEpsilon(o.north, o.south, n.CesiumMath.EPSILON10) ||
        n.CesiumMath.equalsEpsilon(o.east, o.west, n.CesiumMath.EPSILON10)
      )
        return;
      ...
      if (!n.CesiumMath.equalsEpsilon(g, m, 0, n.CesiumMath.EPSILON2)) {
        if (
          ...
          t._offsetAttribute === l.GeometryOffsetAttribute.TOP
            ...
            : ((E =
              ...
              (i = i.fill(E))),
            (d.attributes.applyOffset = new a.GeometryAttribute({
              componentDatatype: n.ComponentDatatype.UNSIGNED_BYTE,
              componentsPerAttribute: 1,
              values: i
            }));
        }
        const c = i.BoundingSphere.fromRectangle3D(o, r, g, y),
          b = i.BoundingSphere.fromRectangle3D(o, r, m, h);
        f = i.BoundingSphere.union(c, b);
      } else {
        if (
          ((d = _(t, p)),
        ...
        f = i.BoundingSphere.fromRectangle3D(o, r, g);
      }
