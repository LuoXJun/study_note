...
define([
  ...
  'use strict';
  const f = Uint16Array.BYTES_PER_ELEMENT,
  ...
  function P(t, e, o, r, s, c, u, h, d, l, g) {
    ...
    for (let p = 0; p < m; ++p) {
      ...
      const x = f.height - u.skirtHeight;
    ...
    const d = (function (u, h, d, l, g, m, p, I, A, y, R) {
        ...
        for (Z = 0, X = 0; X < 4; ++X) {
          ...
          for (let t = 0; t < l; ++t) {
            ...
            let f = (l - W) / (F - W);
            (f = a.CesiumMath.clamp(f, 0, 1)),
              (ot[gt] = new n.Cartesian2(I, f)),
              ++gt;
          }
          const p = 3 * g;
          for (let t = 0; t < p; ++t, ++mt)
            (ct[mt] = m[G.getUint16(Z, !0)]), (Z += f);
        ...
        const Et = 1e-5;
        if (
          (P(it, at, ot, rt, st, ct, ft, ut, -Et * O, !0, -Et * V),
          P(it, at, ot, rt, st, ct, ft, ht, -Et * V, !1),
          P(it, at, ot, rt, st, ct, ft, dt, Et * O, !0, Et * V),
          P(it, at, ot, rt, st, ct, ft, lt, Et * V, !1),
        ...
        const Mt = new o.EllipsoidalOccluder(
          ...
          Nt = new o.TerrainEncoding(h, xt, ft.hMin, q, U, !1, A, D, m, p),
