...
define([
  ...
  './CoplanarPolygonGeometryLibrary-edaba606',
  ...
  const E = new o.Cartesian3(),
    ...
    z = new o.Matrix3(),
    S = new o.Cartesian3();
  function N(e, t, a, i, y, p, u, g, b) {
    const f = e.positions;
    let C = m.PolygonPipeline.triangulate(e.positions2D, e.holes);
    C.length < 3 && (C = [0, 1, 2]);
    const h = d.IndexDatatype.createTypedArray(f.length, C.length);
    h.set(C);
    let x = O;
    if (0 !== i) {
      let e = n.Quaternion.fromAxisAngle(u, i, B);
      if (((x = o.Matrix3.fromQuaternion(e, x)), t.tangent || t.bitangent)) {
        e = n.Quaternion.fromAxisAngle(u, -i, B);
        const a = o.Matrix3.fromQuaternion(e, z);
        (g = o.Cartesian3.normalize(o.Matrix3.multiplyByVector(a, g, g), g)),
          t.bitangent &&
            (b = o.Cartesian3.normalize(o.Cartesian3.cross(u, g, b), b));
      }
    ...
    for (let e = 0; e < A; e++) {
      ...
      if (((w[D++] = n.x), (w[D++] = n.y), (w[D++] = n.z), t.st))
        if (s.defined(y) && y.positions.length === A)
          (_[I++] = y.positions[e].x), (_[I++] = y.positions[e].y);
        else {
          const e = p(o.Matrix3.multiplyByVector(x, n, E), T);
          o.Cartesian2.subtract(e, P, e);
          const t = r.CesiumMath.clamp(e.x / a.width, 0, 1),
            i = r.CesiumMath.clamp(e.y / a.height, 0, 1);
          (_[I++] = t), (_[I++] = i);
        }
      t.normal && ((G[V++] = u.x), (G[V++] = u.y), (G[V++] = u.z)),
        t.tangent && ((F[H++] = g.x), (F[H++] = g.y), (F[H++] = g.z)),
        t.bitangent && ((v[R++] = b.x), (v[R++] = b.y), (v[R++] = b.z));
    }
    const M = new c.GeometryAttributes();
    return (
      t.position &&
        (M.position = new l.GeometryAttribute({
          componentDatatype: r.ComponentDatatype.DOUBLE,
          componentsPerAttribute: 3,
          values: w
        })),
      t.normal &&
        (M.normal = new l.GeometryAttribute({
          componentDatatype: r.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: G
        })),
      t.tangent &&
        (M.tangent = new l.GeometryAttribute({
          componentDatatype: r.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: F
        })),
      t.bitangent &&
        (M.bitangent = new l.GeometryAttribute({
          componentDatatype: r.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: v
        })),
      t.st &&
        (M.st = new l.GeometryAttribute({
          componentDatatype: r.ComponentDatatype.FLOAT,
  ...
  function Q(e) {
    const t = (e = s.defaultValue(e, s.defaultValue.EMPTY_OBJECT))
      ...
      a = s.defaultValue(e.vertexFormat, g.VertexFormat.DEFAULT);
    (this._vertexFormat = g.VertexFormat.clone(a)),
      ...
      (this.packedLength =
        u.PolygonGeometryLibrary.computeHierarchyPackedLength(t, o.Cartesian3) +
        g.VertexFormat.packedLength +
        o.Ellipsoid.packedLength +
        (s.defined(n)
          ? u.PolygonGeometryLibrary.computeHierarchyPackedLength(
              n,
              o.Cartesian2
            )
          : 1) +
  ...
  (Q.fromPositions = function (e) {
    ...
    (Q.pack = function (e, t, n) {
      return (
        ...
        (n = u.PolygonGeometryLibrary.packPolygonHierarchy(
          e._polygonHierarchy,
          t,
          n,
          o.Cartesian3
  ...
  return (
    (Q.unpack = function (e, t, n) {
      ...
      const a = u.PolygonGeometryLibrary.unpackPolygonHierarchy(
        e,
        t,
        o.Cartesian3
      );
      ...
      const l = e[t++],
        c =
          -1 === e[t]
            ? void 0
            : u.PolygonGeometryLibrary.unpackPolygonHierarchy(
                e,
                t,
                o.Cartesian2
              );
    ...
    (Q.createGeometry = function (t) {
      const a = t._vertexFormat,
        c = t._polygonHierarchy,
        m = t._stRotation,
        g = t._textureCoordinates,
        b = s.defined(g);
      let f = c.positions;
      if (
        ((f = e.arrayRemoveDuplicates(f, o.Cartesian3.equalsEpsilon, !0)),
        f.length < 3)
      )
        return;
      let C = D,
      ...
      const L =
        ...
        w = i.CoplanarPolygonGeometryLibrary.createProjectPointTo2DFunction(
          H,
          P,
          A
        );
      a.tangent && (h = o.Cartesian3.clone(P, h)),
        a.bitangent && (x = o.Cartesian3.clone(A, x));
      const G = u.PolygonGeometryLibrary.polygonsFromHierarchy(c, b, L, !1),
        F = G.hierarchy,
        v = G.polygons,
        E = b
          ? u.PolygonGeometryLibrary.polygonsFromHierarchy(
              g,
              !0,
              function (e) {
                return e;
      ...
      f = F[0].outerRing;
      const T = n.BoundingSphere.fromPoints(f),
        k = u.PolygonGeometryLibrary.computeBoundingRectangle(C, w, f, m, _),
        B = [];
      for (let e = 0; e < v.length; e++) {
        const t = new y.GeometryInstance({
          geometry: N(v[e], a, k, m, b ? E[e] : void 0, w, C, h, x)
        });
        B.push(t);
      }
      const O = p.GeometryPipeline.combineInstances(B)[0];
