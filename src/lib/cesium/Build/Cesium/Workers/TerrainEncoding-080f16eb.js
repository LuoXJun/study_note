...
define([
  ...
  const u = i.Ellipsoid.clone(i.Ellipsoid.UNIT_SPHERE);
  (s.prototype.computeHorizonCullingPointPossiblyUnderEllipsoid = function (
    ...
    return f(h(this._ellipsoid, i, u), t, e, o);
  }),
    ...
    (s.prototype.computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid =
      function (t, e, i, o, a, r) {
        return x(h(this._ellipsoid, a, u), t, e, i, o, r);
      });
  const l = [];
  ...
  const _ = new i.Cartesian3(),
    ...
    A = new i.Matrix4(),
    I = Math.pow(2, 12);
  function V(t, e, o, r, n, s, c, d, u, l) {
    let m,
      h,
      f = z.NONE;
    ...
    (this.quantization = f),
      ...
      (this.hasGeodeticSurfaceNormals = a.defaultValue(d, !1)),
      (this.exaggeration = a.defaultValue(u, 1)),
  ...
  V.prototype.encode = function (t, e, o, a, s, c, d, u) {
    const l = a.x,
      m = a.y;
    if (this.quantization === z.BITS12) {
      ...
      const u = r.AttributeCompression.compressTextureCoordinates(H);
