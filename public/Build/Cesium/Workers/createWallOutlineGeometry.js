...
define([
  ...
  './Plane-e916220d'
], function (e, i, t, n, o, a, s, r, l, d, m, u, p, c, f, h, g, y) {
  'use strict';
  ...
  function H(t) {
    ...
    let d = 1 + o.length * i.Cartesian3.packedLength + 2;
    e.defined(s) && (d += s.length),
      e.defined(a) && (d += a.length),
      (this.packedLength = d + i.Ellipsoid.packedLength + 1);
  }
  H.pack = function (t, n, o) {
    ...
    const d = t._maximumHeights;
    if (((r = e.defined(d) ? d.length : 0), (n[o++] = r), e.defined(d)))
      for (a = 0; a < r; ++a) n[o++] = d[a];
    return (
  ...
  return (
    (H.unpack = function (t, n, o) {
      ...
      if (((s = t[n++]), s > 0))
        for (d = new Array(s), a = 0; a < s; ++a) d[a] = t[n++];
      const m = i.Ellipsoid.unpack(t, n, C),
        u = t[(n += i.Ellipsoid.packedLength)];
      return e.defined(o)
        ? ((o._positions = r),
          (o._minimumHeights = l),
          (o._maximumHeights = d),
          (o._ellipsoid = i.Ellipsoid.clone(m, o._ellipsoid)),
          (o._granularity = u),
          o)
        : ((b.positions = r),
          (b.minimumHeights = l),
    ...
    (H.createGeometry = function (o) {
      const d = o._positions,
        m = o._minimumHeights,
        u = o._maximumHeights,
        p = o._granularity,
        c = o._ellipsoid,
        f = l.WallGeometryLibrary.computePositions(c, d, u, m, p, !1);
      ...
      const k = new s.GeometryAttributes({
        ...
        w = H / 3;
      H = 2 * w - 4 + w;
      const x = r.IndexDatatype.createTypedArray(w, H);
      let G = 0;
      for (b = 0; b < w - 2; b += 2) {
        const e = b,
          t = b + 2,
          o = i.Cartesian3.fromArray(C, 3 * e, _),
          a = i.Cartesian3.fromArray(C, 3 * t, E);
