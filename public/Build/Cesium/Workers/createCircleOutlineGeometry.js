...
define([
  ...
  './EllipseOutlineGeometry-418492dc',
...
], function (e, i, t, r, l, n, s, o, a, d, u, m, c, p) {
  'use strict';
  function y(e) {
  ...
  const f = new r.EllipseOutlineGeometry({
  ...
  return (
    (y.unpack = function (i, l, n) {
      const s = r.EllipseOutlineGeometry.unpack(i, l, f);
      return (
        ...
        t.defined(n)
          ? ((G.semiMajorAxis = s._semiMajorAxis),
            ...
            (n._ellipseGeometry = new r.EllipseOutlineGeometry(G)),
            n)
