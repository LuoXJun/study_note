...
], function (e, t, n, i, o, a, l, r, s, p, d, c, u, y, g, h, f, m, E, _, b, P) {
  'use strict';
  function k(n) {
    ...
    (k.createGeometry = function (e) {
      ...
      return (function (e, t) {
        ...
        const i = t.length,
          ...
          r = e.length / 3 / i,
          c = d.IndexDatatype.createTypedArray(l, 2 * i * (r + 1));
        let u,
          y,
          g = 0;
        u = 0;
        let h = u * i;
        for (y = 0; y < i - 1; y++) (c[g++] = y + h), (c[g++] = y + h + 1);
        for (
          c[g++] = i - 1 + h, c[g++] = h, u = r - 1, h = u * i, y = 0;
          y < i - 1;
          y++
        )
          (c[g++] = y + h), (c[g++] = y + h + 1);
        for (c[g++] = i - 1 + h, c[g++] = h, u = 0; u < r - 1; u++) {
          const e = i * u,
            t = e + i;
          for (y = 0; y < i; y++) (c[g++] = y + e), (c[g++] = y + t);
        }
        return new s.Geometry({
          attributes: n,
          indices: d.IndexDatatype.createTypedArray(l, c),
