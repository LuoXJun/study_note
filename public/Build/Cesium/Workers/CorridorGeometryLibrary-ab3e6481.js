...
define([
    ...
    (p[d - 3] = i.x),
      ...
      (m = y
        ? e.Matrix3.fromQuaternion(
            s.Quaternion.fromAxisAngle(e.Cartesian3.negate(a, l), c / u, b),
            A
          )
        : e.Matrix3.fromQuaternion(s.Quaternion.fromAxisAngle(a, c / u, b), A));
    let g = 0;
  ...
  (o.computePositions = function (a) {
    ...
    (A = e.Cartesian3.normalize(e.Cartesian3.subtract(k, j, A), A)),
      (b = o.geodeticSurfaceNormal(j, b)),
      (N = e.Cartesian3.normalize(e.Cartesian3.cross(b, A, N), N)),
      c && (v.push(N.x, N.y, N.z), I.push(b.x, b.y, b.z)),
    ...
    for (H = 1; H < J - 1; H++) {
      ...
      const a = e.Cartesian3.multiplyByScalar(b, e.Cartesian3.dot(A, b), D);
      e.Cartesian3.subtract(A, a, a), e.Cartesian3.normalize(a, a);
      const d = e.Cartesian3.multiplyByScalar(b, e.Cartesian3.dot(T, b), M);
      ...
      if (
        ...
        (L = e.Cartesian3.cross(L, b, L)),
          (L = e.Cartesian3.cross(b, L, L)),
          ...
          r
            ? ((R = e.Cartesian3.add(j, L, R)),
              ...
              y === n.CornerType.ROUNDED || y === n.CornerType.BEVELED
                ? F.push({ leftPositions: B(R, V, Q, y, r) })
                : F.push({
                    leftPositions: E(j, e.Cartesian3.negate(L, L), Q, r)
                  }))
            : ((Q = e.Cartesian3.add(j, L, Q)),
              ...
              y === n.CornerType.ROUNDED || y === n.CornerType.BEVELED
                ? F.push({ rightPositions: B(Q, V, R, y, r) })
                : F.push({ rightPositions: E(j, L, R, r) })),
          (T = e.Cartesian3.negate(A, T));
      }
      j = k;
    }
    ...
    return (
      ...
      y === n.CornerType.ROUNDED &&
        (K = (function (a) {
          ...
          const o = B(t, r, i, n.CornerType.ROUNDED, !1),
            l = a.length - 1,
            C = a[l - 1];
          return (
            (s = a[l]),
            ...
            (t = e.Cartesian3.midpoint(r, i, t)),
            [o, B(t, r, i, n.CornerType.ROUNDED, !1)]
          );
        })(G)),
