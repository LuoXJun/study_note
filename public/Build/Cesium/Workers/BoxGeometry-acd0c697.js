...
define([
  ...
  function p(t) {
    const e = (t = i.defaultValue(t, i.defaultValue.EMPTY_OBJECT)).minimum,
      a = t.maximum,
      r = i.defaultValue(t.vertexFormat, s.VertexFormat.DEFAULT);
  ...
  (p.fromDimensions = function (t) {
    const e = (t = i.defaultValue(t, i.defaultValue.EMPTY_OBJECT)).dimensions,
    ...
    (p.packedLength =
      2 * n.Cartesian3.packedLength + s.VertexFormat.packedLength + 1),
    (p.pack = function (t, e, a) {
      return (
        ...
        (e[a + 2 * n.Cartesian3.packedLength + s.VertexFormat.packedLength] =
          i.defaultValue(t._offsetAttribute, -1)),
        e
      );
    });
  const x = new n.Cartesian3(),
    c = new n.Cartesian3(),
    f = new s.VertexFormat(),
    l = { minimum: x, maximum: c, vertexFormat: f, offsetAttribute: void 0 };
  let A;
  (p.unpack = function (t, e, a) {
    e = i.defaultValue(e, 0);
    const r = n.Cartesian3.unpack(t, e, x),
      o = n.Cartesian3.unpack(t, e + n.Cartesian3.packedLength, c),
      m = s.VertexFormat.unpack(t, e + 2 * n.Cartesian3.packedLength, f),
    ...
    (p.createGeometry = function (t) {
      const a = t._minimum,
        s = t._maximum,
        p = t._vertexFormat;
      if (n.Cartesian3.equals(a, s)) return;
      const x = new m.GeometryAttributes();
      let c, f;
      if (p.position && (p.st || p.normal || p.tangent || p.bitangent)) {
        if (
          (p.position &&
            ...
            (f[70] = a.y),
            (f[71] = s.z),
            (x.position = new o.GeometryAttribute({
          ...
          (t[0] = 0),
            ...
            (t[70] = -1),
            (t[71] = 0),
            (x.normal = new o.GeometryAttribute({
        ...
        if (p.tangent) {
          ...
          (t[0] = 1),
            ...
            (t[70] = 0),
            (t[71] = 0),
            (x.tangent = new o.GeometryAttribute({
              componentDatatype: r.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: t
            }));
        ...
        if (p.bitangent) {
          ...
          (t[0] = 0),
            ...
            (t[70] = 0),
            (t[71] = 1),
            (x.bitangent = new o.GeometryAttribute({
              componentDatatype: r.ComponentDatatype.FLOAT,
              componentsPerAttribute: 3,
              values: t
            }));
        ...
        (f = new Float64Array(24)),
          ...
          (c[34] = 5),
          (c[35] = 4);
      const l = n.Cartesian3.subtract(s, a, y),
        A = 0.5 * n.Cartesian3.magnitude(l);
      if (i.defined(t._offsetAttribute)) {
        const e = f.length,
          n = t._offsetAttribute === u.GeometryOffsetAttribute.NONE ? 0 : 1,
          a = new Uint8Array(e / 3).fill(n);
        x.applyOffset = new o.GeometryAttribute({
