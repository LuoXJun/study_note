...
], function (e, t, r, a, n, o, i, s, d, l, c, f, m, b, p, u, y, G, E, C, _) {
  'use strict';
  return function (a, n) {
    return (
      t.defined(n) && (a = r.EllipseGeometry.unpack(a, n)),
      (a._center = e.Cartesian3.clone(a._center)),
      (a._ellipsoid = e.Ellipsoid.clone(a._ellipsoid)),
      r.EllipseGeometry.createGeometry(a)
    );
  };
});
