...
define([
  ...
  function A(e) {
    ...
    const s = new l.GeometryAttributes({
  ...
  function k(e) {
    ...
    (this._polygonHierarchy = t),
      ...
      (this.packedLength =
        p.PolygonGeometryLibrary.computeHierarchyPackedLength(t, n.Cartesian3) +
        1);
  }
  (k.fromPositions = function (e) {
    ...
    (k.pack = function (e, t, o) {
      return (
        (o = a.defaultValue(o, 0)),
        (t[
          (o = p.PolygonGeometryLibrary.packPolygonHierarchy(
            e._polygonHierarchy,
            t,
            o,
            n.Cartesian3
  ...
  return (
    (k.unpack = function (e, t, o) {
      ...
      const r = p.PolygonGeometryLibrary.unpackPolygonHierarchy(
        e,
        t,
        n.Cartesian3
      );
    ...
    (k.createGeometry = function (o) {
      ...
      const l = p.PolygonGeometryLibrary.polygonOutlinesFromHierarchy(r, !1);
      if (0 === l.length) return;
      const u = [];
      for (let e = 0; e < l.length; e++) {
        const t = new s.GeometryInstance({ geometry: A(l[e]) });
        u.push(t);
      }
      const d = c.GeometryPipeline.combineInstances(u)[0],
