...
define([
  ...
  const s = {
    ...
    isTriangles: function (t) {
      return (
        t === s.TRIANGLES || t === s.TRIANGLE_STRIP || t === s.TRIANGLE_FAN
      );
    },
    validate: function (t) {
      return (
  ...
  (I._textureCoordinateRotationPoints = function (t, n, a, r) {
    ...
    const s = e.Rectangle.center(r, N),
      ...
      C = L,
      d = l;
    (d[0].longitude = r.west),
      (d[0].latitude = r.south),
      (d[1].longitude = r.west),
      (d[1].latitude = r.north),
      (d[2].longitude = r.east),
      (d[2].latitude = r.south);
    let h = f;
    for (o = 0; o < 3; o++)
      e.Cartographic.toCartesian(d[o], a, h),
        ...
        (C[o].x = h.x),
        (C[o].y = h.y);
    const A = i.Quaternion.fromAxisAngle(e.Cartesian3.UNIT_Z, -n, m),
