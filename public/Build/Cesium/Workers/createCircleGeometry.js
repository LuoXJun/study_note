...
define([
  ...
  './Plane-e916220d'
], function (e, t, i, r, o, n, a, s, l, d, m, u, c, p, y, _, G, x, h, f, g) {
  'use strict';
  function E(e) {
  ...
  (E.packedLength = r.EllipseGeometry.packedLength),
    (E.pack = function (e, t, i) {
      return r.EllipseGeometry.pack(e._ellipseGeometry, t, i);
    });
  const b = new r.EllipseGeometry({
  ...
  return (
    (E.unpack = function (t, n, a) {
      const s = r.EllipseGeometry.unpack(t, n, b);
      return (
        (w.center = e.Cartesian3.clone(s._center, w.center)),
        (w.ellipsoid = e.Ellipsoid.clone(s._ellipsoid, w.ellipsoid)),
        (w.height = s._height),
        (w.extrudedHeight = s._extrudedHeight),
        (w.granularity = s._granularity),
        (w.vertexFormat = o.VertexFormat.clone(
          s._vertexFormat,
          w.vertexFormat
        )),
        (w.stRotation = s._stRotation),
        (w.shadowVolume = s._shadowVolume),
        i.defined(a)
          ? ((w.semiMajorAxis = s._semiMajorAxis),
            (w.semiMinorAxis = s._semiMinorAxis),
            (a._ellipseGeometry = new r.EllipseGeometry(w)),
            a)
          : ((w.radius = s._semiMajorAxis), new E(w))
      );
    }),
