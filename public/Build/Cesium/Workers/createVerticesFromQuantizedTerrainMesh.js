...
define([
  ...
  function A(e, r, n, o, a, s, c, d, h) {
    ...
    for (let a = 0; a < T; ++a) {
      const T = e[a],
        f = n[T],
        E = o[T];
      (M.longitude = i.CesiumMath.lerp(m, g, E.x)),
        (M.latitude = i.CesiumMath.lerp(I, l, E.y)),
        (M.height = f - r);
      const p = s.cartographicToCartesian(M, w);
  ...
  function C(e, t, n, o, a, s, d, h, u, l, I, g, m, T) {
    ...
    for (let r = 0; r < S; ++r) {
      const u = n[r],
        S = a[u],
        b = s[u];
      (M.longitude = i.CesiumMath.lerp(N, y, b.x) + m),
        (M.latitude = i.CesiumMath.lerp(p, E, b.y) + T),
        (M.height = S - l);
      const A = h.cartographicToCartesian(M, w);
      if (f) {
        const e = 2 * u;
        (x.x = d[e]), (x.y = d[e + 1]);
      }
  ...
  return d(function (a, d) {
    const h = a.quantizedVertices,
      ...
      T = a.exaggeration,
      f = a.exaggerationRelativeHeight,
      E = 1 !== T,
    ...
    for (let e = 0; e < u; ++e) {
      ...
      (M.longitude = i.CesiumMath.lerp(y, P, o)),
        ...
        m &&
          (Q[e] =
            (c.WebMercatorProjection.geodeticLatitudeToMercatorAngle(
              ...
              Y) *
            O),
        E && (K[e] = k.geodeticSurfaceNormal(d)),
    ...
    const ce = new e.AxisAlignedBoundingBox(X, Z, _),
      de = new n.TerrainEncoding(_, ce, se, H, G, j, m, E, T, f),
      he = de.stride,
