...
define([
...
], function (e, t, i, r, o, a, n, s, d, c, l, m, u, p) {
  'use strict';
  function f(i) {
  ...
  (f.packedLength = r.EllipsoidGeometry.packedLength),
    (f.pack = function (e, t, i) {
      return r.EllipsoidGeometry.pack(e._ellipsoidGeometry, t, i);
    });
  const y = new r.EllipsoidGeometry(),
    G = {
      radius: void 0,
  ...
  return (
    (f.unpack = function (i, a, n) {
      const s = r.EllipsoidGeometry.unpack(i, a, y);
      return (
        (G.vertexFormat = o.VertexFormat.clone(
          s._vertexFormat,
          G.vertexFormat
        )),
        ...
        e.defined(n)
          ? (t.Cartesian3.clone(s._radii, G.radii),
            (n._ellipsoidGeometry = new r.EllipsoidGeometry(G)),
            n)
